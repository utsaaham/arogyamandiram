...
export default function OverviewTab() {
  ...
  return (
    <>
      ...
      <div className="dashboard-unified-card rounded-2xl border p-5 sm:p-7">
        ...
        <div className="mt-6 grid grid-cols-3 gap-3">
          <div className="flex flex-col items-center gap-1.5 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4">
            <ProgressRing
          ...
          <div className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4">
        ...
        !loading && (
          <div className="dashboard-unified-card rounded-2xl border p-5">
            <div className="flex flex-col items-center gap-3 py-8 text-center">
              ...
              <p className="text-sm font-medium text-zinc-300">Your Daily Outlook isn&apos;t written yet</p>
              <p className="max-w-sm text-xs leading-relaxed text-zinc-500">
                Your coach reads your recovery, sleep, training and food history, then briefs you on how to run today.
              </p>
              {hasApiKey && (
                <button
                  onClick={handleGenerate}
