...
export default function WorkoutPlannerLogView({
  log,
  openSections,
  onToggleSection,
  allExpanded,
}: {
  log: WorkoutPlannerDebugLog;
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="w-full">
        <PipelineZone label="Step 2 · Response" open={isOpen('step2')} onToggle={() => handleToggle('step2')}>
          ...
          <StepDivider />
          <div>
            <p className="mb-1.5 text-[10px] font-medium uppercase tracking-widest text-zinc-500">Parsed Plan</p>
