...
export default function AIWorkoutPlanModal({ onClose }: AIWorkoutPlanModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
      ...
      <div className="relative z-10 max-h-[90vh] w-full max-w-md overflow-y-auto rounded-t-3xl border border-neutral-800 bg-workout-bg p-6 shadow-lg animate-slide-up sm:rounded-2xl">
